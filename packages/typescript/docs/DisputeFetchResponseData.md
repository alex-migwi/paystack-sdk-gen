...
**transaction** | [**DisputeFetchResponseDataTransaction**](DisputeFetchResponseDataTransaction.md) |  | [default to undefined]
...
```typescript
import { DisputeFetchResponseData } from '@alex-paystack/sdk';

const instance: DisputeFetchResponseData = {
    id,
    refundAmount,
    currency,
    status,
