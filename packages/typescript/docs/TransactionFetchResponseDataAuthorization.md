...
**expMonth** | **string** |  | [default to undefined]
**expYear** | **string** |  | [default to undefined]
...
**reusable** | **boolean** |  | [default to undefined]
**signature** | **string** |  | [default to undefined]
**accountName** | **string** |  | [default to undefined]
**receiverBankAccountNumber** | **string** |  | [default to undefined]
**receiverBank** | **string** |  | [default to undefined]

## Example

```typescript
import { TransactionFetchResponseDataAuthorization } from '@alex-paystack/sdk';

const instance: TransactionFetchResponseDataAuthorization = {
    authorizationCode,
    bin,
    last4,
    expMonth,
