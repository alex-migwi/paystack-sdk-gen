...
**discount** | [**PaymentRequestFinalizeResponseDataDiscount**](PaymentRequestFinalizeResponseDataDiscount.md) |  | [default to undefined]
...
```typescript
import { PaymentRequestFinalizeResponseData } from '@alex-paystack/sdk';

const instance: PaymentRequestFinalizeResponseData = {
    id,
    integration,
    domain,
    amount,
