...
**authorization** | [**DisputeFetchResponseDataTransactionAuthorization**](DisputeFetchResponseDataTransactionAuthorization.md) |  | [default to undefined]
...
```typescript
import { DisputeFetchResponseDataTransaction } from '@alex-paystack/sdk';

const instance: DisputeFetchResponseDataTransaction = {
    id,
    domain,
    status,
    reference,
