...
**mobileMoney** | [**MobileMoney**](MobileMoney.md) |  | [optional] [default to undefined]
**ussd** | [**USSD**](USSD.md) |  | [optional] [default to undefined]
**eft** | [**EFT**](EFT.md) |  | [optional] [default to undefined]

## Example

```typescript
import { CreateChargeRequest } from '@alex-paystack/sdk';

const instance: CreateChargeRequest = {
    email,
    amount,
    authorizationCode,
    pin,
