...
**integration** | [**PaymentRequestVerifyResponseDataIntegration**](PaymentRequestVerifyResponseDataIntegration.md) |  | [default to undefined]
...
**pendingAmount** | **number** |  | [default to undefined]

## Example

```typescript
import { PaymentRequestVerifyResponseData } from '@alex-paystack/sdk';

const instance: PaymentRequestVerifyResponseData = {
    id,
    integration,
    domain,
    amount,
