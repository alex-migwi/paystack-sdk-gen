...
**receiptNumber** | **string** |  | [default to undefined]
**amount** | **number** |  | [default to undefined]
**message** | **string** |  | [default to undefined]
**gatewayResponse** | **string** |  | [default to undefined]
**helpdeskLink** | **string** |  | [default to undefined]
...
**authorization** | [**TransactionFetchResponseDataAuthorization**](TransactionFetchResponseDataAuthorization.md) |  | [default to undefined]
...
**source** | [**TransactionFetchResponseDataSource**](TransactionFetchResponseDataSource.md) |  | [default to undefined]
**feesBreakdown** | **string** |  | [default to undefined]
**connect** | **string** |  | [default to undefined]

## Example

```typescript
import { TransactionFetchResponseData } from '@alex-paystack/sdk';

const instance: TransactionFetchResponseData = {
    id,
    domain,
    status,
    reference,
